...
if __name__ == '__main__':
    net = InterpolationNet(
            "dataset/interpolation_dataset/train_dataset.csv",
            "dataset/interpolation_dataset/val_dataset.csv",
            "dataset/interpolation_dataset/test_dataset.csv",
